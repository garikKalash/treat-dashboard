...
export class ShelterService {
  ...
  shelterSentItems(id?: string): Observable<ReportView> {
    return this.httpClient.get<ReportView>(`https://3-0-2-f-dot-dogapp-67827.appspot.com/rest/shelter/${id}/report-details`);
  }
  ...
  shelterSentItemsByDate(id?: string, dataRange?: DateRange): Observable<ReportView> {
    ...
    return this.httpClient.get<ReportView>(`https://3-0-2-f-dot-dogapp-67827.appspot.com/rest/shelter/${id}/report-details?from=${start}&to=${end}`);
  }
  ...
  packages(id?: string, dataRange?: DateRange): Observable<ShelterPackage[]> {
    ...
    return this.httpClient.get<ShelterPackage[]>(`https://3-0-2-f-dot-dogapp-67827.appspot.com/rest/shelter/${id}/chewy-packages?from=${start}&to=${end}`);
  }
